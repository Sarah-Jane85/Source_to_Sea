...
with col1:
    st.image(os.path.join(ASSETS_DIR, "garbage_patch.jpg"), use_container_width=True)
    st.markdown("""
...
with col2:
    st.image(os.path.join(ASSETS_DIR, "turtle1.jpg"), use_container_width=True)
    st.markdown("""
    <div style="font-family:'Space Mono',monospace; font-size:0.85rem; color:#ccc7c7;
                text-align:center; margin-top:0.4rem;">
...
with col3:
    st.image(os.path.join(ASSETS_DIR, "inceptors.jpg"), use_container_width=True)
    st.markdown("""
    <div style="font-family:'Space Mono',monospace; font-size:0.85rem; color:#ccc7c7;
                text-align:center; margin-top:0.4rem;">
